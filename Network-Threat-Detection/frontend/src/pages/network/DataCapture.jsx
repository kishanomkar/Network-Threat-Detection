  ...
  return (
    <TerminalLayout title="Data Pipeline & PCAP Capture Manager">
      <div className="space-y-6 font-mono">
        {/* Upload Zone */}
        <div className="bg-[#FAF2CA] border-2 border-dashed border-[#1a2333] hover:border-cyan-500/50 p-8 rounded-sm text-center space-y-3 transition">
          ...
          <div className="pt-2">
            <button className=" hover:bg-slate-200 text-slate-300 px-4 py-2 text-xs font-bold rounded border border-slate-700">
              Browse Local Files
            </button>
          </div>
        </div>
